          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-700">Simulação Prévia Activa</h4>
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-700">Mindset de Abundância</h4>
                <p className="text-[11px] text-slate-500 leading-relaxed font-light">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              {starPhases.map((phase) => (
                <div key={phase.letter} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4">
                  {/* Phase Head */}
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-700 border border-blue-100 flex items-center justify-center font-mono text-sm font-bold shrink-0">
                      {phase.letter}
                    </div>
                    <div>
                  ...
                  <div className="p-3.5 bg-indigo-50 border border-indigo-100 rounded-xl">
                    <span className="text-[10px] font-bold text-indigo-800 uppercase tracking-wider">Instrução de Ouro:</span>
                    <p className="text-xs text-slate-700 font-light leading-relaxed mt-0.5">
                      {phase.actionable}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-[11px]">
                    <div className="p-3 bg-red-50 border border-red-100 rounded-xl">
                      <span className="font-bold text-red-700 uppercase tracking-wider block mb-1">❌ Evite dizer:</span>
                      <p className="text-slate-500 font-light italic leading-relaxed">
                        "{phase.badExample}"
                      </p>
                    </div>
                    <div className="p-3 bg-emerald-50 border border-emerald-100 rounded-xl">
                      <span className="font-bold text-emerald-700 uppercase tracking-wider block mb-1">✅ Diga isso:</span>
